...
async def bot_message(message: types.Message):
        ...
        if await check_sub_channel(message.from_user.id):
            if message.text == '🔎ИСКАТЬ ФИЛЬМ ПО КОДУ':
            ...
            elif message.text == '014':
                 await message.answer('🍿Код: 014 \n<b>Бивень</b>', parse_mode='HTML')
            elif message.text == '015':
            ...
            elif message.text == '018':
                 await message.answer('🍿Код: 018 \n<b>Моя жизнь 1993</b>', parse_mode='HTML')
            elif message.text == '019':
                 await message.answer('🍿Код: 019 \n<b>Соло 1996</b>', parse_mode='HTML')
            elif message.text == '020':
                 await message.answer('🍿Код: 020 \n<b>Побег из Могадишо</b>', parse_mode='HTML')
            elif message.text == '021':
                 await message.answer('🍿Код: 021 \n<b>Дар</b>', parse_mode='HTML')
            elif message.text == '022':
                 await message.answer('🍿Код: 022 \n<b>Царство Небесное</b>', parse_mode='HTML')
            elif message.text == '023':
                await message.answer('🍿Код: 023 \n<b>Волшебное рождество у Микки</b>', parse_mode='HTML')
            elif message.text == '024':
                await message.answer('🍿Код: 024 \n<b>Топ Ган: Маверик</b>', parse_mode='HTML')
            elif message.text == '025':
                ...
                await message.answer('🍿Код: 286 \n<b>Самая опасаная игра 2020</b>', parse_mode='HTML')
                ...
                await message.answer('🍿Код: 200 \n<b>Невидимая сторона 2009</b>', parse_mode='HTML')
            elif message.text == '205':
                await message.answer('🍿Код: 205 \n<b>Всемирный потоп</b>', parse_mode='HTML')
